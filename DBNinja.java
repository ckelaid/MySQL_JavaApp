...
public final class DBNinja {
	...
	public static void addCustomer(Customer c) throws SQLException, IOException {
		 ...
		 */
		String query = "Insert Into customer (CustomerFirstName, CustomerLastName, CustomerPhone) values ("+c.getFName()+","+c.getLName()+","+c.getPhone()+");";
		Statement stmt = conn.createStatement();
		
		stmt.executeQuery(query); // Can I do that?
		//DO NOT FORGET TO CLOSE YOUR CONNECTION
		conn.close();
	}
	...
	public static double getBaseCustPrice(String size, String crust) throws SQLException, IOException {
		...
		String query = "Select BasePrice From base WHERE BaseSize=" + size + "and BaseCrust=" + crust + ";";
		Statement stmt = conn.createStatement();
		ResultSet rset = stmt.executeQuery(query);

		while(rset.next())
		{
			bp = rset.getDouble("BasePrice");
		}
		//DO NOT FORGET TO CLOSE YOUR CONNECTION
		conn.close();
		return bp;
	...
	public static String getCustomerName(int CustID) throws SQLException, IOException
	{
		...
		connect_to_db();
		String ret = "";
		String query = "Select CustomerFirstName, CustomerLastName From customer WHERE CustID=" + CustID + ";";
		Statement stmt = conn.createStatement();
		ResultSet rset = stmt.executeQuery(query);
	...
	public static double getBaseBusPrice(String size, String crust) throws SQLException, IOException {
		...
		String query = "Select BaseCost From base WHERE BaseSize=" + size + "and BaseCrust=" + crust + ";";
		Statement stmt = conn.createStatement();
		ResultSet rset = stmt.executeQuery(query);

		while(rset.next())
		{
			bp = rset.getDouble("BaseCost");
		}
		//DO NOT FORGET TO CLOSE YOUR CONNECTION
		conn.close();
		return bp;
	...
	public static ArrayList<Discount> getDiscountList() throws SQLException, IOException {
		...
		while(rset.next())
		{
			discs.add(new Discount(rset.getInt(0), rset.getString(1), rset.getInt(2), rset.getDouble(3), rset.getString(4)));
		}
	...
	public static ArrayList<Customer> getCustomerList() throws SQLException, IOException {
		...
		*/
		String query = "Select * From customer Order By CustomerLastName;";
		Statement stmt = conn.createStatement();
		ResultSet rset = stmt.executeQuery(query);

		while(rset.next())
		{
			custs.add(new Customer(rset.getInt(0), rset.getString(1), rset.getString(2), rset.getString(3)));
		}
		//DO NOT FORGET TO CLOSE YOUR CONNECTION
		conn.close();
		return custs;
	...
	public static void printToppingPopReport() throws SQLException, IOException
	{
		 ...
		 */
		String query = "Select * From ToppingPopularity Order By Topping limit 1000;";
		Statement stmt = conn.createStatement();
